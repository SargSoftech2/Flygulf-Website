...
// import { loginUser, updatePassword } from "../api/login.api";
// const UserIcon = () => (
...
//         }}
//       >
//         {/* Sliding inner container — 200% wide, slides left on forgot */}
//         <div
...
//               <InputField type="password" placeholder="Password" icon={<LockIcon />} />
...
//               <InputField type="password" placeholder="Current Password" icon={<LockIcon />} />
//               <InputField type="password" placeholder="New Password" icon={<KeyIcon />} />
//               <InputField type="password" placeholder="Confirm Password" icon={<CheckIcon />} />

//               {success && (
//                 <div className="mb-4 text-center text-sm text-green-600 font-semibold bg-green-50 py-2 rounded-xl ring-1 ring-green-200">
...
//               </p>
//               <button
//                 onClick={() => { setIsForgot(false); setSuccess(false); }}
